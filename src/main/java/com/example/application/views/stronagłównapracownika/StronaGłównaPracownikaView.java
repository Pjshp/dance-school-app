package com.example.application.views.stronagłównapracownika;
...
@PermitAll
@Uses(Icon.class)
public class StronaGłównaPracownikaView extends Composite<VerticalLayout> {

    public StronaGłównaPracownikaView() {
        Tabs tabs = new Tabs();
