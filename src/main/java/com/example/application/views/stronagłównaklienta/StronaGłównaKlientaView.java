package com.example.application.views.stronagłównaklienta;
...
@PermitAll
public class StronaGłównaKlientaView extends Composite<VerticalLayout> {

    public StronaGłównaKlientaView() {
